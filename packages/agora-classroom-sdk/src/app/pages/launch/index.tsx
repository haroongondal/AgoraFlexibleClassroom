...
export const LaunchPage = observer(() => {
  ...
  const mountLaunch = useCallback(async (dom: HTMLDivElement) => {
    if (dom) {
      ...
      console.log('launch options: ', launchOption);
      // delete launchOption.scenes;
      // delete launchOption.sdkDomain;
      // delete launchOption.themes;
      // delete launchOption.shareUrl;
      // launchOption.region = 'CN';
      console.log('launch options: ', launchOption);
